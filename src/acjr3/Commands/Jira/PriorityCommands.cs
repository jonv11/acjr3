...
public static class PriorityCommands
{
    public static Command BuildPriorityCommand(IServiceProvider services)
    {
        var priority = new Command("priority", "Jira priority commands");
        priority.AddCommand(BuildListCommand(services));
        return priority;
    }
